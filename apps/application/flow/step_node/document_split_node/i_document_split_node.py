...
class DocumentSplitNodeSerializer(serializers.Serializer):
    ...
    split_strategy = serializers.ChoiceField(
        choices=["auto", "custom", "qa"],
        required=False,
        label=_("split strategy"),
        default="auto",
    )
    ...
    paragraph_title_relate_problem_reference = serializers.ListField(
        required=False,
        label=_("paragraph title relate problem reference"),
    ...
    document_name_relate_problem_reference = serializers.ListField(
        required=False,
        label=_("document name relate problem reference"),
        child=serializers.CharField(),
        default=[],
    )
    ...
    limit_reference = serializers.ListField(
        required=False,
        label=_("limit reference"),
        child=serializers.CharField(),
        default=[],
    )
    chunk_size = serializers.IntegerField(
        required=False, label=_("chunk size"), default=256
    )
    chunk_size_type = serializers.ChoiceField(
        choices=["custom", "referencing"],
        required=False,
        label=_("chunk size type"),
        default="custom",
    )
    chunk_size_reference = serializers.ListField(
        required=False,
        label=_("chunk size reference"),
        child=serializers.CharField(),
        default=[],
    )
    ...
    patterns_type = serializers.ChoiceField(
        choices=["custom", "referencing"],
        required=False,
        label=_("patterns type"),
        default="custom",
    )
    patterns_reference = serializers.ListField(
        required=False,
        label=_("patterns reference"),
        child=serializers.CharField(),
        default=[],
    )
    ...
    with_filter_type = serializers.ChoiceField(
        choices=["custom", "referencing"],
        required=False,
        label=_("with filter type"),
        default="custom",
    )
    with_filter_reference = serializers.ListField(
        required=False,
        label=_("with filter reference"),
        child=serializers.CharField(),
        default=[],
    )
