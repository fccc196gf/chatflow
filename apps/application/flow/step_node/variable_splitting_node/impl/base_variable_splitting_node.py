...
from application.flow.step_node.variable_splitting_node.i_variable_splitting_node import (
    IVariableSplittingNode,
)
...
class BaseVariableSplittingNode(IVariableSplittingNode):
    ...
    def execute(self, input_variable, variable_list, **kwargs) -> NodeResult:
        ...
        response = {
            v["field"]: smart_jsonpath_search(input_variable, v["expression"])
