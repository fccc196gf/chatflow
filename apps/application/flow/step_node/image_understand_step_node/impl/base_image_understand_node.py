...
from application.flow.step_node.image_understand_step_node.i_image_understand_node import (
    IImageUnderstandNode,
)
...
class BaseImageUnderstandNode(IImageUnderstandNode):
    ...
    def execute(
        ...
        **kwargs,
        ...
        image_model = get_model_instance_by_model_workspace_id(
                ...
                return HumanMessage(
                    content=[
                        ...
                        *[
                            {
                                "type": "image_url",
                                "image_url": {"url": f"./oss/file/{file_id}"},
                            }
                        ...
                        *[
                            {
                                "type": "image_url",
                                "image_url": {
                                    "url": f"data:image/{base64_image[1]};base64,{base64_image[0]}"
                                },
                            }
    ...
    def generate_message_list(
        self, image_model, system: str, prompt: str, history_message, image
    ):
        ...
        if images:
            messages = [
                HumanMessage(content=[{"type": "text", "text": prompt_text}, *images])
            ]
        else:
