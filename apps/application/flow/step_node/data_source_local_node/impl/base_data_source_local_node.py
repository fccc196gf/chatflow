...
from application.flow.step_node.data_source_local_node.i_data_source_local_node import (
    IDataSourceLocalNode,
)
...
class BaseDataSourceLocalNode(IDataSourceLocalNode):
    ...
    def execute(
        ...
        return NodeResult(
            {
                "file_list": self.workflow_manage.params.get("data_source", {}).get(
                    "file_list"
                )
            },
