...
from application.api.application_chat import (
    ApplicationChatQueryAPI,
...
class PromptGenerateView(APIView):
    ...
    def post(
        self, request: Request, workspace_id: str, model_id: str, application_id: str
    ):
