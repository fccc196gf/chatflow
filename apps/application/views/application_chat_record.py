...
class ApplicationChatRecord(APIView):
    ...
    @has_permissions(
        PermissionConstants.APPLICATION_CHAT_LOG_READ.get_workspace_application_permission(),
    ...
    def get(
        self, request: Request, workspace_id: str, application_id: str, chat_id: str
    ):
...
class ApplicationChatRecordAddKnowledge(APIView):
    ...
    @has_permissions(
        PermissionConstants.APPLICATION_CHAT_LOG_ADD_KNOWLEDGE.get_workspace_application_permission(),
...
class ApplicationChatRecordImprove(APIView):
    ...
    @has_permissions(
        PermissionConstants.APPLICATION_CHAT_LOG_ANNOTATION.get_workspace_application_permission(),
...
class ApplicationChatRecordImproveParagraph(APIView):
    ...
    def put(
        ...
        return result.success(
            ...
            ).improve(request.data, request=request)
        )
