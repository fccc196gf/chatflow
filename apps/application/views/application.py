...
from application.api.application_api import (
    ApplicationCreateAPI,
    ApplicationQueryAPI,
    ApplicationImportAPI,
    ApplicationExportAPI,
    ApplicationOperateAPI,
    ApplicationEditAPI,
    TextToSpeechAPI,
    SpeechToTextAPI,
    PlayDemoTextAPI,
...
class ApplicationAPI(APIView):
    ...
    @has_permissions(
        PermissionConstants.APPLICATION_CREATE.get_workspace_permission(),
        RoleConstants.USER.get_workspace_role(),
        RoleConstants.WORKSPACE_MANAGE.get_workspace_role(),
    )
    @log(
        menu="Application",
        operate="Create an application",
    ...
    def get(self, request: Request, workspace_id: str):
        return result.success(
            Query(data={"workspace_id": workspace_id, "user_id": request.user.id}).list(
    ...
    class Import(APIView):
        ...
        @has_permissions(
            PermissionConstants.APPLICATION_IMPORT.get_workspace_permission(),
            RoleConstants.USER.get_workspace_role(),
            RoleConstants.WORKSPACE_MANAGE.get_workspace_role(),
        )
        @log(
            menu="Application",
            operate="Import Application",
        )
        def post(self, request: Request, workspace_id: str, folder_id: str):
            is_import_tool = get_is_permissions(
                request, workspace_id=workspace_id, folder_id=folder_id
            )(
            ...
            return result.success(
                ApplicationSerializer(
                    ...
                    {"file": request.FILES.get("file"), "folder_id": folder_id},
                    is_import_tool,
                )
            )
    ...
    class Export(APIView):
        ...
        @has_permissions(
            PermissionConstants.APPLICATION_EXPORT.get_workspace_application_permission(),
        ...
        @log(
            menu="Application",
            operate="Export Application",
            get_operation_object=lambda r, k: get_application_operation_object(
    ...
    class Operate(APIView):
        ...
        @log(
            menu="Application",
            operate="Modify the application",
            get_operation_object=lambda r, k: get_application_operation_object(
                k.get("application_id")
            ),
        )
    ...
    class Publish(APIView):
        ...
        @log(
            menu="Application",
            operate="Publishing an application",
            get_operation_object=lambda r, k: get_application_operation_object(
                k.get("application_id")
            ),
        )
    ...
    class StoreApplication(APIView):
        ...
        def get(self, request: Request):
            return result.success(
                ApplicationSerializer.StoreApplication(
                    data={
                        "user_id": request.user.id,
...
class McpServers(APIView):
    ...
    def post(self, request: Request, workspace_id, application_id: str):
        return result.success(
            ApplicationOperateSerializer(
                data={
                    "mcp_servers": request.query_params.get("mcp_servers"),
                    "workspace_id": workspace_id,
                    "user_id": request.user.id,
                    "application_id": application_id,
                }
