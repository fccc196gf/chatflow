...
class Trigger(AppModelMixin):
    ...
    trigger_type = models.CharField(
        verbose_name="触发器类型",
        choices=TriggerTypeChoices.choices,
        default=TriggerTypeChoices.SCHEDULED,
        max_length=256,
    )
...
class TriggerTask(AppModelMixin):
    ...
    source_type = models.CharField(
        ...
        choices=TriggerTaskTypeChoices.choices,
        default=TriggerTaskTypeChoices.APPLICATION,
        max_length=256,
    )
...
class TaskRecord(AppModelMixin):
    ...
    trigger_task_id = models.UUIDField(
        max_length=128, default=uuid.uuid7, editable=False, verbose_name="触发器任务id"
    )
