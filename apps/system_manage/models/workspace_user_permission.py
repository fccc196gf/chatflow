...
class WorkspaceUserResourcePermission(models.Model):
    ...
    workspace_id = models.CharField(
        max_length=128, verbose_name="工作空间id", default="default", db_index=True
    )

    user = models.ForeignKey(
        User, on_delete=models.CASCADE, verbose_name="工作空间下的用户"
    )
    ...
    target = models.CharField(
        max_length=128, verbose_name="知识库/应用id", db_index=True
    )
    ...
    auth_type = models.CharField(
        default=False,
        verbose_name="授权类型",
        choices=ResourceAuthType.choices,
