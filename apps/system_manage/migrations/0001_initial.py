    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nick_name",
                    models.CharField(
                        db_index=True, max_length=150, unique=True, verbose_name="昵称"
                    ),
                ),
                (
                    "username",
                ...
                (
                    "update_time",
                    models.DateTimeField(
                        auto_now=True, db_index=True, null=True, verbose_name="修改时间"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operate",
                    models.CharField(
                        db_index=True, max_length=128, verbose_name="操作"
                    ),
                ),
                (
                    "operation_object",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=150, unique=True, verbose_name="名称"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "target",
                    models.UUIDField(db_index=True, verbose_name="知识库/应用id"),
                ),
                (
                    "auth_type",
                    models.CharField(
                        choices=[
                            ("ROLE", "Role"),
                            ("RESOURCE_PERMISSION_GROUP", "Resource Permission Group"),
                        ],
                        db_default="ROLE",
                        db_index=True,
                        default=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resource_type",
                    models.CharField(
                        choices=[("KNOWLEDGE", "知识库"), ("APPLICATION", "应用")],
                        db_index=True,
                        verbose_name="资源类型",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "unique_together": {
                    ("user_group_id", "resource_type", "resource_id", "user_id")
                },
            },
        ),
    ]
