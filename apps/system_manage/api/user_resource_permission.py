...
from system_manage.serializers.user_resource_permission import (
    ResourceUserPermissionEditRequest,
    UpdateTeamMemberItemPermissionSerializer,
)
...
class ResourceUserPermissionResponse(serializers.Serializer):
    ...
    nick_name = serializers.CharField(
        required=True, allow_null=True, allow_blank=True, label=_("nick_name")
    )
    username = serializers.CharField(
        required=True, allow_null=True, allow_blank=True, label=_("username")
    )
...
class ResourceUserPermissionEditAPI(APIMixin):
    ...
    @staticmethod
    def get_request():
        return ResourceUserPermissionEditRequest(
            required=True, many=True, label=_("users_permission")
        )
