...
class SystemSetting(APIView):
    class Email(APIView):
        ...
        @log(
            menu="Email settings",
            operate="Test email settings",
            get_details=get_email_details,
        )
        def post(self, request: Request):
            return result.success(
                EmailSettingSerializer.Create(data=request.data).is_valid()
            )
        ...
        def get(self, request: Request):
            return result.success(EmailSettingSerializer.one())
