...
class WorkSpaceUserResourcePermissionView(APIView):
    ...
    @has_permissions(
        lambda r, kwargs: Permission(
            group=Group(kwargs.get("resource") + "_WORKSPACE_USER_RESOURCE_PERMISSION"),
    ...
    class Page(APIView):
        ...
        @has_permissions(
            lambda r, kwargs: Permission(
                group=Group(
                    kwargs.get("resource") + "_WORKSPACE_USER_RESOURCE_PERMISSION"
                ),
                operate=Operate.READ,
            ),
            RoleConstants.ADMIN,
...
class WorkspaceResourceUserPermissionView(APIView):
    ...
    @has_permissions(
        lambda r, kwargs: Permission(
            group=Group(kwargs.get("resource")),
        ...
        ViewPermission(
            ...
            [
                lambda r, kwargs: Permission(
                    group=Group(kwargs.get("resource").replace("_FOLDER", "")),
    ...
    @log(
        menu="System",
        operate="Edit user authorization status of resource",
        get_operation_object=lambda r, k: get_user_operation_object(k.get("user_id")),
    )
    @has_permissions(
        lambda r, kwargs: Permission(
