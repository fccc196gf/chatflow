...
class MCPToolHandler:
    def __init__(self, auth_header):
        app_key = (
            ...
            .filter(secret_key=auth_header, is_active=True)
            .first()
        )
        if not app_key:
        ...
        self.application = (
            ...
            .filter(id=app_key.application_id, is_publish=True)
            .first()
        )
    ...
    def initialize(self):
        return {
            ...
            "serverInfo": {"name": "chatflow-mcp", "version": "1.0.0"},
            "capabilities": {"tools": {}},
        }
    ...
    def call_tool(self, params):
        ...
        payload = {"message": args.get("message"), "stream": False, "re_chat": False}
        ...
        return {
            "content": [{"type": "text", "text": data.get("data", {}).get("content")}]
        }
