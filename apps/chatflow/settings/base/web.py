...
SECRET_KEY = (
    ...
    or "django-insecure-zm^1_^i5)3gp^&0io6zg72&z!a*d=9kf9o2%uft+27l)+t(#3e"
)
# 允许跨域 opener，解决非 HTTPS 环境下的 COOP 问题
...
# 支持的语言
LANGUAGES = [("en", "English"), ("zh", "中文简体"), ("zh-hant", "中文繁体")]
# 翻译文件路径
LOCALE_PATHS = [os.path.join(BASE_DIR.parent, "locales")]
...
if os.environ.get("CHATFLOW_REDIS_SENTINEL_SENTINELS") is not None:
