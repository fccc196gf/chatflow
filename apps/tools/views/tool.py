...
class ToolView(APIView):
    ...
    class Operate(APIView):
        ...
        @log(
            menu="Tool",
            operate="Update tool",
            get_operation_object=lambda r, k: get_tool_operation_object(
                k.get("tool_id")
            ),
        )
    ...
    class Pylint(APIView):
        ...
        def post(self, request: Request, workspace_id: str):
            return result.success(
                ToolSerializer.Pylint(data={"workspace_id": workspace_id}).run(
                    request.data
                )
            )
            ...
            return result.success(
                ToolSerializer.UpdateStoreTool(
                    data={
                        ...
                        "download_callback_url": request.data.get(
                            "download_callback_url"
                        ),
    ...
    class ToolRecord(APIView):
        ...
        def get(
            self, request: Request, tool_id: str, workspace_id: str, record_id: str
        ):
            return result.success(
                ToolSerializer.ToolRecord(
                    data={
