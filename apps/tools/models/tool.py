...
class Tool(AppModelMixin):
    ...
    template_id = models.CharField(
        max_length=128, verbose_name="模版id", null=True, default=None, db_index=True
    )
    ...
    init_params = models.CharField(
        max_length=102400, verbose_name="初始化参数", null=True
    )
    label = models.CharField(
        max_length=128, verbose_name="标签", null=True, db_index=True
    )
    version = models.CharField(
        max_length=64, verbose_name="版本号", null=True, default=None
    )
...
class ToolRecord(AppModelMixin):
    ...
    source_type = models.CharField(
        ...
        choices=ToolTaskTypeChoices.choices,
        default=ToolTaskTypeChoices.APPLICATION,
        max_length=256,
    )
    source_id = models.UUIDField(verbose_name="资源id")
    meta = models.JSONField(default=dict, encoder=SystemEncoder)
    state = models.CharField(
        verbose_name="状态", max_length=20, choices=State.choices, default=State.STARTED
    )
