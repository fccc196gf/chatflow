...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=64, verbose_name="工具名称"
                    ),
                ),
                ("desc", models.CharField(max_length=128, verbose_name="描述")),
                (
                    "code",
                    models.CharField(max_length=102400, verbose_name="python代码"),
                ),
                (
                    "input_field_list",
                    models.JSONField(default=list, verbose_name="输入字段列表"),
                ),
                (
                    "init_field_list",
                    models.JSONField(default=list, verbose_name="启动字段列表"),
                ),
                (
                    "icon",
                    models.CharField(
                        default="", max_length=256, verbose_name="工具库icon"
                    ),
                ),
                ...
                (
                    "tool_type",
                    models.CharField(
                        choices=[("INTERNAL", "内置"), ("CUSTOM", "自定义")],
                        db_index=True,
                        default="CUSTOM",
                        max_length=20,
                        verbose_name="工具类型",
                ...
                (
                    "template_id",
                    models.UUIDField(
                        db_index=True, default=None, null=True, verbose_name="模版id"
                    ),
                ),
                (
                    "workspace_id",
                ...
                (
                    "label",
                    models.CharField(
                        db_index=True, max_length=128, null=True, verbose_name="标签"
                    ),
                ),
                (
                    "user",
        ...
        migrations.RunSQL(
            get_file_content(
                os.path.join(
                    PROJECT_DIR, "apps", "tools", "migrations", "internal_tool.sql"
                )
            )
        ),
    ]
