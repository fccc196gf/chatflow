        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=128, verbose_name="名称"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "model_type",
                    models.CharField(
                        db_index=True, max_length=128, verbose_name="模型类型"
                    ),
                ),
                (
                    "model_name",
                    models.CharField(
                        db_index=True, max_length=128, verbose_name="模型名称"
                    ),
                ),
                (
                    "provider",
                    models.CharField(
                        db_index=True, max_length=128, verbose_name="供应商"
                    ),
                ),
                (
                    "credential",
                    models.CharField(max_length=102400, verbose_name="模型认证信息"),
                ),
                (
                    "meta",
                    models.JSONField(
                        default=dict,
                        verbose_name="模型元数据,用于存储下载,或者错误信息",
                    ),
                ),
                (
                    "model_params_form",
                    models.JSONField(default=list, verbose_name="模型参数配置"),
                ),
                (
                    "workspace_id",
                    models.CharField(
