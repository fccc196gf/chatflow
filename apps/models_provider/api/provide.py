...
class ModelParamsFormSerializer(serializers.Serializer):
    ...
    relation_show_field_dict = serializers.DictField(
        required=False, label=_("relation show field dict")
    )
    relation_trigger_field_dict = serializers.DictField(
        required=False, label=_("relation trigger field dict")
    )
