...
class ZhiPuTTIModelParams(BaseForm):
    size = forms.SingleSelect(
        TooltipLabel(
            _("Image size"),
            _(
                "Image size, only cogview-3-plus supports this parameter. Optional range: [1024x1024,768x1344,864x1152,1344x768,1152x864,1440x720,720x1440], the default is 1024x1024."
            ),
        ),
        required=True,
