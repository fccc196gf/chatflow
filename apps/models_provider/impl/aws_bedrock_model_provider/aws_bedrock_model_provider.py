...
from models_provider.impl.aws_bedrock_model_provider.credential.embedding import (
    BedrockEmbeddingCredential,
)
from models_provider.impl.aws_bedrock_model_provider.credential.image import (
    BedrockVLModelCredential,
)
from models_provider.impl.aws_bedrock_model_provider.credential.llm import (
    BedrockLLMModelCredential,
)
from models_provider.impl.aws_bedrock_model_provider.credential.reranker import (
    BedrockRerankerCredential,
)
from models_provider.impl.aws_bedrock_model_provider.model.embedding import (
...
from models_provider.impl.aws_bedrock_model_provider.model.reranker import (
    BedrockRerankerModel,
)


def _create_model_info(
    model_name, description, model_type, credential_class, model_class
):
    return ModelInfo(
        name=model_name,
        desc=description,
...
def _initialize_model_info():
    model_info_list = [
        _create_model_info(
            ...
            _(
                "An update to Claude 2 that doubles the context window and improves reliability, hallucination rates, and evidence-based accuracy in long documents and RAG contexts."
            ),
            ModelTypeConst.LLM,
            BedrockLLMModelCredential,
            BedrockModel,
        ...
        _create_model_info(
            "anthropic.claude-v2",
            _(
                "Anthropic is a powerful model that can handle a variety of tasks, from complex dialogue and creative content generation to detailed command obedience."
            ),
            ModelTypeConst.LLM,
            BedrockLLMModelCredential,
            BedrockModel,
        ...
        _create_model_info(
            ...
            _(
                "The Claude 3.5 Sonnet raises the industry standard for intelligence, outperforming competing models and the Claude 3 Opus in extensive evaluations, with the speed and cost-effectiveness of our mid-range models."
            ),
            ModelTypeConst.LLM,
            BedrockLLMModelCredential,
            BedrockModel,
        ...
        _create_model_info(
            ...
            _(
                "A faster, more affordable but still very powerful model that can handle a range of tasks including casual conversation, text analysis, summarization and document question answering."
            ),
            ModelTypeConst.LLM,
            BedrockLLMModelCredential,
            BedrockModel,
        ...
        _create_model_info(
            ...
            _(
                "Amazon Titan Text Lite is a lightweight, efficient model ideal for fine-tuning English-language tasks, including summarization and copywriting, where customers require smaller, more cost-effective, and highly customizable models."
            ),
            ModelTypeConst.LLM,
            BedrockLLMModelCredential,
            BedrockModel,
        ...
        _create_model_info(
            ...
            _(
                "7B dense converter for rapid deployment and easy customization. Small in size yet powerful in a variety of use cases. Supports English and code, as well as 32k context windows."
            ),
            ModelTypeConst.LLM,
            BedrockLLMModelCredential,
            BedrockModel,
        ...
        _create_model_info(
            ...
            _(
                "Advanced Mistral AI large-scale language model capable of handling any language task, including complex multilingual reasoning, text understanding, transformation, and code generation."
            ),
            ModelTypeConst.LLM,
            BedrockLLMModelCredential,
            BedrockModel,
        ...
        _create_model_info(
            ...
            _(
                "Ideal for limited computing power and resources, edge devices, and faster training times."
            ),
            ModelTypeConst.LLM,
            BedrockLLMModelCredential,
            BedrockModel,
    ...
    embedded_model_info_list = [
        _create_model_info(
            ...
            _(
                "Titan Embed Text is the largest embedding model in the Amazon Titan Embed series and can handle various text embedding tasks, such as text classification, text similarity calculation, etc."
            ),
...
class BedrockModelProvider(IModelProvider):
    ...
    def get_model_provide_info(self):
        ...
        return ModelProvideInfo(
            provider="model_aws_bedrock_provider", name="Amazon Bedrock", icon=icon_data
        )
