...
from models_provider.impl.aws_bedrock_model_provider.model.llm import (
    _update_aws_credentials,
)


class BedrockEmbeddingModel(CHATFLOWBaseModel, BedrockEmbeddings):
    def __init__(
        self, model_id: str, region_name: str, credentials_profile_name: str, **kwargs
    ):
        super().__init__(
            model_id=model_id,
