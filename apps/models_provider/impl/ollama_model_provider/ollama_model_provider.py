...
from models_provider.impl.ollama_model_provider.credential.embedding import (
    OllamaEmbeddingModelCredential,
)
from models_provider.impl.ollama_model_provider.credential.image import (
    OllamaImageModelCredential,
)
from models_provider.impl.ollama_model_provider.credential.llm import (
    OllamaLLMModelCredential,
)
from models_provider.impl.ollama_model_provider.credential.reranker import (
    OllamaReRankModelCredential,
)
...
model_info_list = [
    ...
    ModelInfo(
        "llama2",
        _(
            "Llama 2 is a set of pretrained and fine-tuned generative text models ranging in size from 7 billion to 70 billion. This is a repository of 7B pretrained models. Links to other models can be found in the index at the bottom."
        ),
        ModelTypeConst.LLM,
        ollama_llm_model_credential,
        OllamaChatModel,
    ...
    ModelInfo(
        "llama2:13b",
        _(
            "Llama 2 is a set of pretrained and fine-tuned generative text models ranging in size from 7 billion to 70 billion. This is a repository of 13B pretrained models. Links to other models can be found in the index at the bottom."
        ),
        ModelTypeConst.LLM,
        ollama_llm_model_credential,
        OllamaChatModel,
    ...
    ModelInfo(
        "llama2:70b",
        _(
            "Llama 2 is a set of pretrained and fine-tuned generative text models ranging in size from 7 billion to 70 billion. This is a repository of 70B pretrained models. Links to other models can be found in the index at the bottom."
        ),
        ModelTypeConst.LLM,
        ollama_llm_model_credential,
        OllamaChatModel,
    ...
    ModelInfo(
        "llama2-chinese:13b",
        _(
            "Since the Chinese alignment of Llama2 itself is weak, we use the Chinese instruction set to fine-tune meta-llama/Llama-2-13b-chat-hf with LoRA so that it has strong Chinese conversation capabilities."
        ),
        ModelTypeConst.LLM,
        ollama_llm_model_credential,
        OllamaChatModel,
    ...
    ModelInfo(
        "llama3:8b",
        _(
            "Meta Llama 3: The most capable public product LLM to date. 8 billion parameters."
        ),
        ModelTypeConst.LLM,
        ollama_llm_model_credential,
        OllamaChatModel,
    ...
    ModelInfo(
        "llama3:70b",
        _(
            "Meta Llama 3: The most capable public product LLM to date. 70 billion parameters."
        ),
        ModelTypeConst.LLM,
        ollama_llm_model_credential,
        OllamaChatModel,
    ...
    ModelInfo(
        "qwen:14b",
        _(
            "Compared with previous versions, qwen 1.5 14b has significantly enhanced the model's alignment with human preferences and its multi-language processing capabilities. Models of all sizes support a context length of 32768 tokens. 14 billion parameters."
        ),
        ModelTypeConst.LLM,
        ollama_llm_model_credential,
        OllamaChatModel,
    ...
    ModelInfo(
        "qwen:32b",
        _(
            "Compared with previous versions, qwen 1.5 32b has significantly enhanced the model's alignment with human preferences and its multi-language processing capabilities. Models of all sizes support a context length of 32768 tokens. 32 billion parameters."
        ),
        ModelTypeConst.LLM,
        ollama_llm_model_credential,
        OllamaChatModel,
...
embedding_model_info = [
    ModelInfo(
        ...
        ollama_embedding_model_credential,
        OllamaEmbedding,
    ),
]
reranker_model_info = [
    ModelInfo(
        ...
        ollama_reranker_model_credential,
        OllamaReranker,
    ),
]
...
image_model_info = [
    ModelInfo(
        "llava:7b", "", ModelTypeConst.IMAGE, ollama_image_model_credential, OllamaImage
    ),
    ModelInfo(
        "llava:13b",
        "",
        ModelTypeConst.IMAGE,
        ollama_image_model_credential,
        OllamaImage,
    ),
    ModelInfo(
        "llava:34b",
