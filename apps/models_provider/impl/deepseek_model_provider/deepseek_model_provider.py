...
from models_provider.impl.deepseek_model_provider.credential.llm import (
...
deepseek_chat = ModelInfo(
    "deepseek-chat",
    _("Good at common conversational tasks, supports 32K contexts"),
    ModelTypeConst.LLM,
    deepseek_llm_model_credential,
    DeepSeekChatModel,
)

deepseek_coder = ModelInfo(
    "deepseek-coder",
    _("Good at handling programming tasks, supports 16K contexts"),
    ModelTypeConst.LLM,
    deepseek_llm_model_credential,
    DeepSeekChatModel,
)
...
model_info_manage = (
    ...
    .append_model_info(deepseek_reasoner)
    .append_model_info(deepseek_chat)
    .append_model_info(deepseek_coder)
    .append_default_model_info(deepseek_coder)
    .build()
)
