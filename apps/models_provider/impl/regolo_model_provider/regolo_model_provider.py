...
from models_provider.impl.regolo_model_provider.credential.embedding import (
    RegoloEmbeddingCredential,
)
from models_provider.impl.regolo_model_provider.credential.llm import (
    RegoloLLMModelCredential,
)
from models_provider.impl.regolo_model_provider.credential.tti import (
    RegoloTextToImageModelCredential,
)
from models_provider.impl.regolo_model_provider.model.embedding import (
...
model_info_list = [
    ModelInfo(
        "Phi-4", "", ModelTypeConst.LLM, openai_llm_model_credential, RegoloChatModel
    ),
    ModelInfo(
