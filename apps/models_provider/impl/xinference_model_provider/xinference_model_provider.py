...
from models_provider.impl.xinference_model_provider.credential.image import (
    XinferenceImageModelCredential,
)
from models_provider.impl.xinference_model_provider.credential.llm import (
    XinferenceLLMModelCredential,
)
from models_provider.impl.xinference_model_provider.credential.reranker import (
    XInferenceRerankerModelCredential,
)
from models_provider.impl.xinference_model_provider.credential.stt import (
    XInferenceSTTModelCredential,
)
from models_provider.impl.xinference_model_provider.credential.tti import (
    XinferenceTextToImageModelCredential,
)
from models_provider.impl.xinference_model_provider.credential.tts import (
    XInferenceTTSModelCredential,
)
from models_provider.impl.xinference_model_provider.model.embedding import (
    XinferenceEmbedding,
)
...
from models_provider.impl.xinference_model_provider.model.reranker import (
    XInferenceReranker,
)
from models_provider.impl.xinference_model_provider.model.stt import (
    XInferenceSpeechToText,
)
from models_provider.impl.xinference_model_provider.model.tti import (
    XinferenceTextToImage,
)
from models_provider.impl.xinference_model_provider.model.tts import (
...
Code Llama Instruct is a fine-tuned version of Code Llama's instructions, designed to perform specific tasks.
    ...
    ModelInfo(
        "code-llama-python",
        _(
            "Code Llama Python is a language model specifically designed for Python code generation."
        ),
        ModelTypeConst.LLM,
        xinference_llm_model_credential,
        XinferenceChatModel,
...
class XinferenceModelProvider(IModelProvider):
    ...
    def get_base_model_list(api_base, api_key, model_type):
        ...
        r = requests.request(
            method="GET", url=f"{base_url}/models", headers=headers, timeout=5
        )
        r.raise_for_status()
