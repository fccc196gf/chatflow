...
class XinferenceTextToImage(CHATFLOWBaseModel, BaseTextToImage):
    api_base: str
    api_key: str
    model: str
    params: dict
    ...
    def generate_image(self, prompt: str, negative_prompt: str = None):
        ...
        res = chat.images.generate(
            model=self.model, prompt=prompt, response_format="b64_json", **self.params
        )
        file_urls = []
        # 临时文件
        for img in res.data:
