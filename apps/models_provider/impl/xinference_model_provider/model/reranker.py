...
class XInferenceReranker(CHATFLOWBaseModel, BaseDocumentCompressor):
    ...
    def new_instance(
        ...
        return XInferenceReranker(
            server_url=model_credential.get("server_url"),
    ...
    def compress_documents(
        ...
        return [
            Document(
                page_content=d.get("document", {}).get("text"),
                metadata={"relevance_score": d.get("relevance_score")},
            )
