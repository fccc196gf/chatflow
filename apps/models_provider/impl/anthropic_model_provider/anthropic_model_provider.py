...
from models_provider.impl.anthropic_model_provider.credential.image import (
    AnthropicImageModelCredential,
)
from models_provider.impl.anthropic_model_provider.credential.llm import (
    AnthropicLLMModelCredential,
)
