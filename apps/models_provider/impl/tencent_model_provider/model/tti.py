...
class TencentTextToImageModel(CHATFLOWBaseModel, BaseTextToImage):
    ...
    def generate_image(self, prompt: str, negative_prompt: str = None):
        try:
            ...
            cred = credential.Credential(
                self.hunyuan_secret_id, self.hunyuan_secret_key
            )
            ...
            chatflow_logger.error(f"Tencent Text to Image API call failed: {err}")
