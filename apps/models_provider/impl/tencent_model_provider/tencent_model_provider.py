...
from models_provider.impl.tencent_model_provider.credential.embedding import (
    TencentEmbeddingCredential,
)
from models_provider.impl.tencent_model_provider.credential.image import (
    TencentVisionModelCredential,
)
from models_provider.impl.tencent_model_provider.credential.llm import (
    TencentLLMModelCredential,
)
from models_provider.impl.tencent_model_provider.credential.stt import (
    TencentSTTModelCredential,
)
from models_provider.impl.tencent_model_provider.credential.tti import (
    TencentTTIModelCredential,
)
from models_provider.impl.tencent_model_provider.model.embedding import (
...
from models_provider.impl.tencent_model_provider.model.tti import (
...
class TencentModelProvider(IModelProvider):
    ...
    def get_model_provide_info(self):
        ...
        return ModelProvideInfo(
            provider="model_tencent_provider", name=_("Tencent Hunyuan"), icon=icon_data
        )
