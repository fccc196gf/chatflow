...
from models_provider.impl.vllm_model_provider.credential.embedding import (
    VllmEmbeddingCredential,
)
from models_provider.impl.vllm_model_provider.credential.image import (
    VllmImageModelCredential,
)
from models_provider.impl.vllm_model_provider.credential.llm import VLLMModelCredential
from models_provider.impl.vllm_model_provider.credential.reranker import (
    VllmRerankerCredential,
)
from models_provider.impl.vllm_model_provider.credential.whisper_stt import (
    VLLMWhisperModelCredential,
)
...
from models_provider.impl.vllm_model_provider.model.whisper_sst import (
    VllmWhisperSpeechToText,
)
...
model_info_list = [
    ModelInfo(
        ...
        ModelTypeConst.LLM,
        v_llm_model_credential,
        VllmChatModel,
    ),
    ModelInfo(
        "BAAI/Aquila-7B",
        _("BAAI’s 7B parameter model"),
        ModelTypeConst.LLM,
        v_llm_model_credential,
        VllmChatModel,
    ),
