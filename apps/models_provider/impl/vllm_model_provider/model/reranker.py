...
class VllmBgeReranker(CHATFLOWBaseModel, BaseDocumentCompressor):
    api_key: str
    api_url: str
    model: str
    params: dict
    ...
    def __init__(self, **kwargs):
        ...
        self.client = cohere.ClientV2(
            kwargs.get("api_key"), base_url=kwargs.get("api_url")
        )
    ...
    def new_instance(
        ...
        r_url = (
            model_credential.get("api_url")[:-3]
    ...
    def compress_documents(
        ...
        return [
            Document(
                page_content=d.document.get("text"),
                metadata={"relevance_score": d.relevance_score},
            )
