...
from models_provider.impl.docker_ai_model_provider.credential.embedding import (
    DockerAIEmbeddingCredential,
)
from models_provider.impl.docker_ai_model_provider.credential.image import (
    DockerAIImageModelCredential,
)
from models_provider.impl.docker_ai_model_provider.credential.llm import (
    DockerAILLMModelCredential,
)
from models_provider.impl.docker_ai_model_provider.credential.reranker import (
    DockerAIRerankerCredential,
)
from models_provider.impl.docker_ai_model_provider.credential.stt import (
    DockerAISTTModelCredential,
)
from models_provider.impl.docker_ai_model_provider.credential.tti import (
    DockerAITextToImageModelCredential,
)
from models_provider.impl.docker_ai_model_provider.credential.tts import (
    DockerAITTSModelCredential,
)
from models_provider.impl.docker_ai_model_provider.model.embedding import (
...
from models_provider.impl.docker_ai_model_provider.model.reranker import (
    DockerAIReranker,
)
...
model_info_list = [
    ModelInfo(
        ...
        "",
        ModelTypeConst.LLM,
        docker_ai_llm_model_credential,
        DockerAIChatModel,
    ),
]
...
model_info_rerank_list = [
    ModelInfo(
        ...
        docker_ai_reranker_model_credential,
        DockerAIReranker,
    ),
]
model_info_manage = (
    ...
    .append_default_model_info(
        ModelInfo(
            "gpt-3.5-turbo",
            _("The latest gpt-3.5-turbo, updated with DockerAI adjustments"),
            ModelTypeConst.LLM,
            docker_ai_llm_model_credential,
            DockerAIChatModel,
        )
