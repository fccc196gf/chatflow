...
from models_provider.impl.azure_model_provider.credential.embedding import (
    AzureOpenAIEmbeddingCredential,
)
from models_provider.impl.azure_model_provider.credential.image import (
    AzureOpenAIImageModelCredential,
)
from models_provider.impl.azure_model_provider.credential.llm import (
    AzureLLMModelCredential,
)
from models_provider.impl.azure_model_provider.credential.stt import (
    AzureOpenAISTTModelCredential,
)
from models_provider.impl.azure_model_provider.credential.tti import (
    AzureOpenAITextToImageModelCredential,
)
from models_provider.impl.azure_model_provider.credential.tts import (
    AzureOpenAITTSModelCredential,
)
from models_provider.impl.azure_model_provider.model.azure_chat_model import (
    AzureChatModel,
)
from models_provider.impl.azure_model_provider.model.embedding import (
...
default_model_info = [
    ModelInfo(
        ...
        "",
        ModelTypeConst.LLM,
        base_azure_llm_model_credential,
        AzureChatModel,
...
image_model_info = [
    ModelInfo(
        ...
        base_azure_image_model_credential,
        AzureOpenAIImage,
        api_version="2023-05-15",
    ),
    ModelInfo(
...
tti_model_info = [
    ModelInfo(
        ...
        "",
        ModelTypeConst.TTI,
        base_azure_tti_model_credential,
...
tts_model_info = [
    ModelInfo(
        ...
        "",
        ModelTypeConst.TTS,
        base_azure_tts_model_credential,
...
stt_model_info = [
    ModelInfo(
        ...
        "",
        ModelTypeConst.STT,
        base_azure_stt_model_credential,
