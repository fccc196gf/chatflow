...
from models_provider.impl.siliconCloud_model_provider.credential.llm import (
    SiliconCloudLLMModelCredential,
)
from models_provider.impl.siliconCloud_model_provider.credential.reranker import (
    SiliconCloudRerankerCredential,
)
from models_provider.impl.siliconCloud_model_provider.credential.stt import (
    SiliconCloudSTTModelCredential,
)
from models_provider.impl.siliconCloud_model_provider.credential.tti import (
    SiliconCloudTextToImageModelCredential,
)
from models_provider.impl.siliconCloud_model_provider.credential.tts import (
    SiliconCloudTTSModelCredential,
)
from models_provider.impl.siliconCloud_model_provider.model.embedding import (
    SiliconCloudEmbeddingModel,
)
from models_provider.impl.siliconCloud_model_provider.model.llm import (
    SiliconCloudChatModel,
)
from models_provider.impl.siliconCloud_model_provider.model.reranker import (
    SiliconCloudReranker,
)
from models_provider.impl.siliconCloud_model_provider.model.stt import (
    SiliconCloudSpeechToText,
)
from models_provider.impl.siliconCloud_model_provider.model.tti import (
    SiliconCloudTextToImage,
)
from models_provider.impl.siliconCloud_model_provider.model.tts import (
...
model_rerank_list = [
    ModelInfo(
        ...
        openai_reranker_model_credential,
        SiliconCloudReranker,
    ),
    ModelInfo(
