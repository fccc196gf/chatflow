...
class QwenModelParams(BaseForm):
    ...
    size = SingleSelect(
        TooltipLabel(
            _("Image size"),
            _("Specify the size of the generated image, such as: 1024x1024"),
        ),
        required=True,
    ...
    n = SliderField(
        TooltipLabel(
            _("Number of pictures"), _("Specify the number of generated images")
        ),
        required=True,
        default_value=1,
        _min=1,
        ...
        option_list=[
            {
                "value": "<auto>",
                "label": _(
                    "Default value, the image style is randomly output by the model"
                ),
            },
