...
from chatflow.settings import chatflow_logger
...
class AliyunBaiLianDefaultSTTModelCredential(BaseForm, BaseModelCredential):
    type = forms.SingleSelect(
        ...
        value_field="value",
        option_list=[
            {"label": _("Audio file recognition - Tongyi Qwen"), "value": "qwen"},
            {"label": _("Qwen-Omni"), "value": "omni"},
            {
    ...
    api_url = forms.TextInputField(
        _("API URL"), required=True, relation_show_field_dict={"type": ["qwen", "omni"]}
    )
