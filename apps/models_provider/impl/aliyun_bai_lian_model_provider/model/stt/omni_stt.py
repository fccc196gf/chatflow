...
class AliyunBaiLianOmiSpeechToText(CHATFLOWBaseModel, BaseSpeechToText):
    api_key: str
    api_url: str
    model: str
    params: dict
    ...
    def speech_to_text(self, audio_file):
        try:
            ...
            chatflow_logger.error(f":Error: {str(err)}: {traceback.format_exc()}")
            raise err
