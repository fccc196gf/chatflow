...
from models_provider.impl.aliyun_bai_lian_model_provider.credential.stt.asr_stt import (
...
from models_provider.impl.aliyun_bai_lian_model_provider.credential.image import (
    QwenVLModelCredential,
)
from models_provider.impl.aliyun_bai_lian_model_provider.credential.itv import (
    ImageToVideoModelCredential,
)
from models_provider.impl.aliyun_bai_lian_model_provider.credential.llm import (
    BaiLianLLMModelCredential,
)
from models_provider.impl.aliyun_bai_lian_model_provider.credential.stt.omni_stt import (
    AliyunBaiLianOmiSTTModelCredential,
)
from models_provider.impl.aliyun_bai_lian_model_provider.credential.reranker import (
    AliyunBaiLianRerankerCredential,
)
from models_provider.impl.aliyun_bai_lian_model_provider.credential.stt import (
    AliyunBaiLianSTTModelCredential,
    AliyunBaiLianDefaultSTTModelCredential,
)
from models_provider.impl.aliyun_bai_lian_model_provider.credential.tti import (
    QwenTextToImageModelCredential,
)
from models_provider.impl.aliyun_bai_lian_model_provider.credential.tts import (
    AliyunBaiLianTTSModelCredential,
)
from models_provider.impl.aliyun_bai_lian_model_provider.credential.ttv import (
    TextToVideoModelCredential,
)
from models_provider.impl.aliyun_bai_lian_model_provider.model.stt.asr_stt import (
...
from models_provider.impl.aliyun_bai_lian_model_provider.model.image import (
    QwenVLChatModel,
)
from models_provider.impl.aliyun_bai_lian_model_provider.model.llm import (
    BaiLianChatModel,
)
from models_provider.impl.aliyun_bai_lian_model_provider.model.stt.omni_stt import (
...
from models_provider.impl.aliyun_bai_lian_model_provider.model.tti import (
    QwenTextToImageModel,
)
from models_provider.impl.aliyun_bai_lian_model_provider.model.tts import (
    AliyunBaiLianTextToSpeech,
)
from chatflow.conf import PROJECT_DIR
from django.utils.translation import gettext as _, gettext

from models_provider.impl.aliyun_bai_lian_model_provider.model.ttv import (
...
model_info_list = [
    ModelInfo(
        "gte-rerank-v2",
        _(
            "With the GTE-Rerank text sorting series model developed by Alibaba Tongyi Lab, developers can integrate high-quality text retrieval and sorting through the LlamaIndex framework."
        ),
        ModelTypeConst.RERANKER,
        aliyun_bai_lian_model_credential,
        AliyunBaiLianReranker,
    ),
    ModelInfo(
        "paraformer-realtime-v2",
        _(
            "Chinese (including various dialects such as Cantonese), English, Japanese, and Korean support free switching between multiple languages."
        ),
        ModelTypeConst.STT,
        aliyun_bai_lian_stt_model_credential,
        AliyunBaiLianSpeechToText,
    ),
    ModelInfo(
        "cosyvoice-v1",
        _(
            "CosyVoice is based on a new generation of large generative speech models, which can predict emotions, intonation, rhythm, etc. based on context, and has better anthropomorphic effects."
        ),
        ModelTypeConst.TTS,
        aliyun_bai_lian_tts_model_credential,
        AliyunBaiLianTextToSpeech,
    ),
    ModelInfo(
        "text-embedding-v1",
    ...
    ModelInfo(
        "qwen-omni-turbo",
        _(
            "The Qwen Omni series model supports inputting multiple modalities of data, including video, audio, images, and text, and outputting audio and text."
        ),
        ModelTypeConst.STT,
        aliyun_bai_lian_omi_stt_model_credential,
        AliyunBaiLianOmiSpeechToText,
    ),
    ModelInfo(
        "qwen2.5-omni-7b",
    ...
    ModelInfo(
        "qwen-audio-asr",
        _(
            "The Qwen Audio based end-to-end speech recognition model supports audio recognition within 3 minutes. At present, it mainly supports Chinese and English recognition."
        ),
        ModelTypeConst.STT,
        aliyun_bai_lian_asr_stt_model_credential,
        AliyunBaiLianAsrSpeechToText,
    ),
]
...
model_info_ttv_list = [
    ModelInfo(
        ...
        "",
        ModelTypeConst.TTV,
        aliyun_bai_lian_ttv_model_credential,
        GenerationVideoModel,
    ),
    ModelInfo(
        "wanx2.1-t2v-turbo",
...
module_info_itv_list = [
    ModelInfo(
        ...
        "",
        ModelTypeConst.ITV,
        aliyun_bai_lian_itv_model_credential,
        GenerationVideoModel,
    ),
    ModelInfo(
        "wan2.2-i2v-plus",
