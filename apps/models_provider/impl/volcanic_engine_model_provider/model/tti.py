...
class VolcanicEngineTextToImage(CHATFLOWBaseModel, BaseTextToImage):
    api_key: str
    api_base: str
    model_version: str
    params: dict
    ...
    def new_instance(
        ...
        return VolcanicEngineTextToImage(
            ...
            api_base=model_credential.get("volcanic_api_url")
            or "https://ark-api.volcengine.com",
            **optional_params,
        )
    ...
    def generate_image(self, prompt: str, negative_prompt: str = None):
        ...
        imagesResponse = client.images.generate(
            model=self.model_version, prompt=prompt, **self.params
        )
