...
from models_provider.impl.openai_model_provider.credential.embedding import (
    OpenAIEmbeddingCredential,
)
from models_provider.impl.openai_model_provider.credential.image import (
    OpenAIImageModelCredential,
)
from models_provider.impl.openai_model_provider.credential.llm import (
    OpenAILLMModelCredential,
)
from models_provider.impl.openai_model_provider.credential.stt import (
    OpenAISTTModelCredential,
)
from models_provider.impl.openai_model_provider.credential.tti import (
    OpenAITextToImageModelCredential,
)
from models_provider.impl.openai_model_provider.credential.tts import (
    OpenAITTSModelCredential,
)
from models_provider.impl.openai_model_provider.model.embedding import (
...
model_info_list = [
    ModelInfo(
        "gpt-3.5-turbo",
        _("The latest gpt-3.5-turbo, updated with OpenAI adjustments"),
        ModelTypeConst.LLM,
    ...
    ModelInfo(
        "gpt-4",
        _("Latest gpt-4, updated with OpenAI adjustments"),
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ),
    ModelInfo(
        "gpt-4o",
        _(
            "The latest GPT-4o, cheaper and faster than gpt-4-turbo, updated with OpenAI adjustments"
        ),
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ...
    ModelInfo(
        "gpt-4o-mini",
        _(
            "The latest gpt-4o-mini, cheaper and faster than gpt-4o, updated with OpenAI adjustments"
        ),
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ...
    ModelInfo(
        "gpt-4-turbo",
        _("The latest gpt-4-turbo, updated with OpenAI adjustments"),
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ),
    ModelInfo(
        "gpt-4-turbo-preview",
        _("The latest gpt-4-turbo-preview, updated with OpenAI adjustments"),
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ),
    ModelInfo(
        "gpt-3.5-turbo-0125",
        _(
            "gpt-3.5-turbo snapshot on January 25, 2024, supporting context length 16,385 tokens"
        ),
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ...
    ModelInfo(
        "gpt-3.5-turbo-1106",
        _(
            "gpt-3.5-turbo snapshot on November 6, 2023, supporting context length 16,385 tokens"
        ),
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ...
    ModelInfo(
        "gpt-4-0125-preview",
        _(
            "gpt-4-turbo snapshot on January 25, 2024, supporting context length 128,000 tokens"
        ),
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ...
    ModelInfo(
        "gpt-4-1106-preview",
        _(
            "gpt-4-turbo snapshot on November 6, 2023, supporting context length 128,000 tokens"
        ),
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ...
    ModelInfo(
        ...
        "",
        ModelTypeConst.STT,
        openai_stt_model_credential,
        OpenAISpeechToText,
    ),
    ModelInfo(
        "tts-1", "", ModelTypeConst.TTS, openai_tts_model_credential, OpenAITextToSpeech
    ),
]
