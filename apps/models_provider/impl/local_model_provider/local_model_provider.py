...
from models_provider.impl.local_model_provider.credential.embedding import (
    LocalEmbeddingCredential,
)
from models_provider.impl.local_model_provider.credential.reranker import (
...
embedding_text2vec_base_chinese = ModelInfo(
...
model_info_manage = (
    ...
    .append_model_info(embedding_text2vec_base_chinese)
