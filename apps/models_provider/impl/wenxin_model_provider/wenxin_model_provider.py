...
from models_provider.impl.wenxin_model_provider.credential.embedding import (
    QianfanEmbeddingCredential,
)
from models_provider.impl.wenxin_model_provider.credential.llm import (
    WenxinLLMModelCredential,
)
...
model_info_list = [
    ModelInfo(
        "ERNIE-Bot-4",
        _(
            "ERNIE-Bot-4 is a large language model independently developed by Baidu. It covers massive Chinese data and has stronger capabilities in dialogue Q&A, content creation and generation."
        ),
        ModelTypeConst.LLM,
    ...
    ModelInfo(
        "ERNIE-Bot",
        _(
            "ERNIE-Bot is a large language model independently developed by Baidu. It covers massive Chinese data and has stronger capabilities in dialogue Q&A, content creation and generation."
        ),
        ModelTypeConst.LLM,
        win_xin_llm_model_credential,
        QianfanChatModel,
    ...
    ModelInfo(
        "ERNIE-Bot-turbo",
        _(
            "ERNIE-Bot-turbo is a large language model independently developed by Baidu. It covers massive Chinese data, has stronger capabilities in dialogue Q&A, content creation and generation, and has a faster response speed."
        ),
        ModelTypeConst.LLM,
        win_xin_llm_model_credential,
        QianfanChatModel,
