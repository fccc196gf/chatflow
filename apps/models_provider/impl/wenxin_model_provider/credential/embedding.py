...
class QianfanEmbeddingCredential(BaseForm, BaseModelCredential):
        ...
        if api_version == "v1":
            ...
            if not any(
                ...
                raise AppApiException(
                    ...
                    _("{model_type} Model type is not supported").format(
            ...
            if not model_info.__contains__(model_name.lower()):
                raise AppApiException(
                    ValidCode.valid_error.value,
                    _("{model_name} The model does not support").format(
    ...
    def encryption_dict(self, model: Dict[str, object]):
        ...
        if api_version == "v1":
            return {
                **model,
                "qianfan_sk": super().encryption(model.get("qianfan_sk", "")),
            }
        else:  # v2
            return {
                **model,
                "qianfan_ak": super().encryption(model.get("qianfan_ak", "")),
            }
    ...
    qianfan_sk = forms.PasswordInputField(
