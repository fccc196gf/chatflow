...
class XunFeiSuperHumanoidTTSModelParams(BaseForm):
    ...
    vcn = forms.SingleSelect(
        TooltipLabel(
            _("Speaker"), _("Speaker selection for super-humanoid TTS service")
        ),
        required=True,
        default_value="x5_lingxiaoxuan_flow",
        text_field="label",
        value_field="value",
        option_list=[
            {
                "label": _("Super-humanoid: Lingxiaoxuan Flow"),
                "value": "x5_lingxiaoxuan_flow",
            },
            {
                "label": _("Super-humanoid: Lingyuyan Flow"),
                "value": "x5_lingyuyan_flow",
            },
            {
                "label": _("Super-humanoid: Lingfeiyi Flow"),
                "value": "x5_lingfeiyi_flow",
            },
            {
                "label": _("Super-humanoid: Lingxiaoyue Flow"),
                "value": "x5_lingxiaoyue_flow",
            },
            {
                "label": _("Super-humanoid: Sun Dasheng Flow"),
                "value": "x5_sundasheng_flow",
            },
            {
                "label": _("Super-humanoid: Lingyuzhao Flow"),
                "value": "x5_lingyuzhao_flow",
            },
            {
                "label": _("Super-humanoid: Lingxiaotang Flow"),
                "value": "x5_lingxiaotang_flow",
            },
            {
                "label": _("Super-humanoid: Lingxiaorong Flow"),
                "value": "x5_lingxiaorong_flow",
            },
            ...
            {
                "label": _("Super-humanoid: Lingwanwan Pro"),
                "value": "x6_lingwanwan_pro",
            },
            {"label": _("Super-humanoid: Yiyi Pro"), "value": "x6_yiyi_pro"},
            {"label": _("Super-humanoid: Huifangnv Pro"), "value": "x6_huifangnv_pro"},
            {
                "label": _("Super-humanoid: Lingxiaoying Pro"),
                "value": "x6_lingxiaoying_pro",
            },
    ...
    speed = forms.SliderField(
        TooltipLabel(
            _("speaking speed"),
            _("Speech speed, optional value: [0-100], default is 50"),
        ),
        required=True,
        default_value=50,
        _min=1,
...
class XunFeiSuperHumanoidTTSModelCredential(BaseForm, BaseModelCredential):
    ...
    def is_valid(
        ...
        if not any(
            list(filter(lambda mt: mt.get("value") == model_type, model_type_list))
        ):
            raise AppApiException(
                ValidCode.valid_error.value,
                gettext("{model_type} Model type is not supported").format(
        ...
        try:
            model = provider.get_model(
                model_type, model_name, model_credential, **model_params
            )
            model.check_auth()
