...
from models_provider.serializers.model_serializer import (
    ModelSerializer,
...
class ModelSetting(APIView):
    ...
    @has_permissions(
        PermissionConstants.MODEL_CREATE.get_workspace_permission(),
    ...
    def post(self, request: Request, workspace_id: str):
        return result.success(
            ...
            ).insert(workspace_id, with_valid=True)
        )
    ...
    def get(self, request: Request, workspace_id: str):
        return result.success(
            ...
            ).list(workspace_id=workspace_id, with_valid=True)
        )
    ...
    class Operate(APIView):
        ...
        @has_permissions(
            PermissionConstants.MODEL_EDIT.get_workspace_model_permission(),
            RoleConstants.WORKSPACE_MANAGE.get_workspace_role(),
            PermissionConstants.MODEL_EDIT.get_workspace_permission_workspace_manage_role(),
            ViewPermission(
                [RoleConstants.USER.get_workspace_role()],
        ...
        @log(
            ...
            get_operation_object=lambda r, k: get_model_operation_object(
                k.get("model_id")
            ),
            get_details=get_edit_model_details,
        )
        def put(self, request: Request, workspace_id, model_id: str):
            return result.success(
                ...
                ).edit(request.data, str(request.user.id))
            )
        ...
        @has_permissions(
            PermissionConstants.MODEL_DELETE.get_workspace_model_permission(),
    ...
    class ModelParamsForm(APIView):
        ...
        @log(
            menu="model",
            operate="Save model parameter form",
            get_operation_object=lambda r, k: get_model_operation_object(
                k.get("model_id")
            ),
        )
    ...
    class PauseDownload(APIView):
        ...
        @has_permissions(
            PermissionConstants.MODEL_CREATE.get_workspace_model_permission(),
