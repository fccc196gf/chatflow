...
class Provide(APIView):
            ...
            for key in ModelProvideConstants.__members__:
                if (
                    len(
                        [
                            item
                            for item in ModelProvideConstants[
                                key
                            ].value.get_model_type_list()
                    ...
                    providers.append(
                        ModelProvideConstants[key]
                        .value.get_model_provide_info()
                        .to_dict()
                    )
    ...
    class ModelTypeList(APIView):
        ...
        def get(self, request: Request):
            ...
            return result.success(
                ModelProvideConstants[provider].value.get_model_type_list()
            )
    ...
    class ModelList(APIView):
        ...
        def get(self, request: Request):
            ...
            return result.success(
                ModelProvideConstants[provider].value.get_model_list(model_type)
            )
    ...
    class ModelParamsForm(APIView):
        ...
        def get(self, request: Request):
            ...
            return result.success(
                get_default_model_params_setting(provider, model_type, model_name)
            )
    ...
    class ModelForm(APIView):
        ...
        def get(self, request: Request):
            ...
            model_name = request.query_params.get("model_name")
            return result.success(
                ModelProvideConstants[provider]
