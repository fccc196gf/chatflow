...
from knowledge.api.problem import (
    ProblemReadAPI,
    ProblemBatchCreateAPI,
    BatchAssociationAPI,
    BatchDeleteAPI,
    ProblemPageAPI,
    ProblemDeleteAPI,
...
class ProblemView(APIView):
    ...
    class BatchAssociation(APIView):
        ...
        @log(
            menu="problem",
            operate="Batch associated paragraphs",
            get_operation_object=lambda r, keywords: get_knowledge_operation_object(
                keywords.get("knowledge_id")
            ),
        )
        def put(self, request: Request, workspace_id: str, knowledge_id: str):
            return result.success(
                ProblemSerializers.BatchOperate(
