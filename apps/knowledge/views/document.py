            ...
            return result.success(
                DocumentSerializers.Query(
                    data={
                        ...
                        "hit_handling_method": request.query_params.get(
                            "hit_handling_method"
                        ),
    ...
    @log(
        ...
        get_operation_object=lambda r, keywords: get_knowledge_document_operation_object(
            get_knowledge_operation_object(keywords.get("knowledge_id")),
            {
                ...
                "document_list": [
                    {"name": url} for url in r.data.get("source_url_list", [])
                ],
            },
        ),
    )
    ...
    @log(
        ...
        get_operation_object=lambda r, keywords: get_knowledge_document_operation_object(
            get_knowledge_operation_object(keywords.get("knowledge_id")),
            {
                ...
                "document_list": [
                    {"name": file.name} for file in r.FILES.getlist("file")
                ],
            },
        ),
    )
...
class Template(APIView):
    ...
    def get(self, request: Request):
        return DocumentSerializers.Export(
