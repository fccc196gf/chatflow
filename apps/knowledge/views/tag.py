...
class KnowledgeTagView(APIView):
    ...
    @log(
        menu="tag",
        operate="Create a knowledge tag",
    ...
    class Operate(APIView):
        ...
        @log(
            menu="tag",
            operate="Update a knowledge tag",
            get_operation_object=lambda r, keywords: get_knowledge_operation_object(
                keywords.get("knowledge_id")
            ),
        )
        def put(
            self, request: Request, workspace_id: str, knowledge_id: str, tag_id: str
        ):
            return result.success(
                TagSerializers.Operate(
                    data={
                        "workspace_id": workspace_id,
                        "knowledge_id": knowledge_id,
                        "tag_id": tag_id,
    ...
    class Delete(APIView):
        ...
        @log(
            menu="tag",
            operate="Delete a knowledge tag",
            get_operation_object=lambda r, keywords: get_knowledge_operation_object(
                keywords.get("knowledge_id")
            ),
        )
    ...
    class BatchDelete(APIView):
        ...
        @log(
            menu="tag",
            operate="Batch Delete knowledge tag",
            get_operation_object=lambda r, keywords: get_knowledge_operation_object(
                keywords.get("knowledge_id")
            ),
        )
