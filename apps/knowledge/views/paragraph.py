...
from knowledge.api.paragraph import (
    ParagraphReadAPI,
    ParagraphCreateAPI,
    ParagraphBatchDeleteAPI,
    ParagraphEditAPI,
    ParagraphGetAPI,
    ProblemCreateAPI,
    UnAssociationAPI,
...
class ParagraphView(APIView):
    ...
    class BatchMigrate(APIView):
        ...
        @log(
            menu="Paragraph",
            operate="Migrate paragraphs in batches",
            get_operation_object=lambda r, keywords: get_knowledge_document_operation_object(
                get_knowledge_operation_object(keywords.get("knowledge_id")),
                get_document_operation_object(keywords.get("document_id")),
            ),
    ...
    class BatchGenerateRelated(APIView):
        ...
        @log(
            menu="Paragraph",
            operate="Batch generate related",
            get_operation_object=lambda r, keywords: get_knowledge_document_operation_object(
                get_knowledge_operation_object(keywords.get("knowledge_id")),
                get_document_operation_object(keywords.get("document_id")),
            ),
    ...
    class Problem(APIView):
        ...
        @log(
            menu="Paragraph",
            operate="Add associated questions",
            get_operation_object=lambda r, keywords: get_knowledge_document_operation_object(
                get_knowledge_operation_object(keywords.get("knowledge_id")),
                get_document_operation_object(keywords.get("document_id")),
            ),
    ...
    class UnAssociation(APIView):
        ...
        def put(
            ...
            return result.success(
                ParagraphSerializers.Association(
                    data={
                        "workspace_id": workspace_id,
                        "knowledge_id": knowledge_id,
                        "document_id": document_id,
