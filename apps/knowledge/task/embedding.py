...
def get_embedding_model(
    model_id,
    exception_handler=lambda e: chatflow_logger.error(
...
def embedding_by_knowledge(knowledge_id, model_id):
    ...
    chatflow_logger.info(
        _("Start--->Vectorized knowledge: {knowledge_id}").format(
    ...
    try:
        ...
        chatflow_logger.error(
            _(
                "Vectorized knowledge: {knowledge_id} error {error} {traceback}".format(
                    knowledge_id=knowledge_id,
                    error=str(e),
        ...
        chatflow_logger.info(
            _("End--->Vectorized knowledge: {knowledge_id}").format(
                knowledge_id=knowledge_id
            )
        )
