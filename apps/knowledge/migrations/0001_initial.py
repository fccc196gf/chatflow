    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file_name",
                    models.CharField(
                        default="", max_length=256, verbose_name="文件名称"
                    ),
                ),
                ("file_size", models.IntegerField(default=0, verbose_name="文件大小")),
                (
                    "sha256_hash",
                    models.CharField(default="", verbose_name="文件sha256_hash标识"),
                ),
                (
                    "source_type",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=150, verbose_name="知识库名称"
                    ),
                ),
                (
                    "workspace_id",
                ...
                (
                    "scope",
                    models.CharField(
                        choices=[("SHARED", "共享"), ("WORKSPACE", "工作空间可用")],
                        db_index=True,
                        default="WORKSPACE",
                        max_length=20,
                        verbose_name="可用范围",
                ...
                (
                    "file_size_limit",
                    models.IntegerField(default=100, verbose_name="文件大小限制"),
                ),
                (
                    "file_count_limit",
                    models.IntegerField(default=50, verbose_name="文件数量限制"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=150, verbose_name="文档名称"
                    ),
                ),
                (
                    "char_length",
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        default=knowledge.models.knowledge.get_default_status,
                        max_length=20,
                        verbose_name="状态",
                    ),
                ),
                (
                    "status_meta",
                    models.JSONField(
                        default=knowledge.models.knowledge.default_status_meta,
                        verbose_name="状态统计数据",
                    ),
                ),
                ...
                (
                    ...
                    models.FloatField(default=0.9, verbose_name="直接回答相似度"),
                ),
                ("meta", models.JSONField(default=dict, verbose_name="元数据")),
                (
                    "knowledge",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content",
                    models.CharField(max_length=102400, verbose_name="段落内容"),
                ),
                (
                    "title",
                    models.CharField(
                        db_index=True, default="", max_length=256, verbose_name="标题"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "position",
                    models.IntegerField(
                        db_index=True, default=0, verbose_name="段落顺序"
                    ),
                ),
                (
                    "document",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, max_length=1, verbose_name="是否可用"
                    ),
                ),
                (
                    "embedding",
                    knowledge.models.knowledge.VectorField(verbose_name="向量"),
                ),
                (
                    "search_vector",
                    django.contrib.postgres.search.SearchVectorField(
                        default="", verbose_name="分词"
                    ),
                ),
                ("meta", models.JSONField(default=dict, verbose_name="元数据")),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content",
                    models.CharField(
                        db_index=True, max_length=256, verbose_name="问题内容"
                    ),
                ),
                ("hit_num", models.IntegerField(default=0, verbose_name="命中次数")),
                (
