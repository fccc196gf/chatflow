...
hg = huggingface()
prefix_dir = "/opt/chatflow-app/model"
os.makedirs(prefix_dir, exist_ok=True)
for item in ["base", "embedding", "tokenizer"]:
    os.makedirs(os.path.join(prefix_dir, item), exist_ok=True)

os.makedirs(r"/opt/chatflow-app/tmp", exist_ok=True)
