export default {
  ...
  defaultSlogan: 'General Intelligent Agent Platform',
  ...
  defaultTip: 'The default is the ChatFlow platform interface, supports custom settings',
  logoDefaultTip: 'The default is the ChatFlow login interface, supports custom settings',
