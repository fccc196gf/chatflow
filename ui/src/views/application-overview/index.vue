...
const apiUrl = window.location.origin + `${window.ChatFlow.chatPrefix}/api-doc/`

const baseUrl = window.location.origin + `${window.ChatFlow.chatPrefix}/api/`
...
const shareUrl = computed(
  () =>
    `${window.location.origin}${window.ChatFlow.chatPrefix}/` +
